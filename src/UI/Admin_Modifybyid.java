/*
 * Created by JFormDesigner on Tue Oct 11 14:50:02 CST 2022
 */
 ...
 * @author unknown
 */
public class Admin_Modifybyid extends JFrame {
    Database db = new Database();

    public Admin_Modifybyid() {
        initComponents();
        comboBox2();
    }
    ...
    private void button1(ActionEvent e)  {
        try {
            ...
            if (compareid.next()) {
                if (compareid.getString(1).equals(id)) {
            ...
            staff_dao.DeleteStaff(c, textField3.getText());
            this2.dispose();
            new Admin_Control().setVisible(true);
            dialog1.setVisible(true);
    ...
    private void comboBox2ItemStateChanged(ItemEvent e) {
        try(Connection c= db.getCon()) {String did= (String) comboBox2.getSelectedItem();
            Department_dao department_dao=new Department_dao();
